...
<body> 
		...
		<div class="header">
			<div class="container">
				<div class="header-w3lsrow"> 
					...
					<div class="logo">
						<h1><a href="home.action" >${user.username }</a></h1>
					</div>  
					<div class="header-right">   
						<ul>
							<li><a href="<%=path %>/user/toLogin.action">SignIn</a></li>
							<li><a href="toSignup.action">SignUp</a></li> 
						</ul>
						<div class="clearfix"> </div> 
					</div>
					<div class="clearfix"> </div>
				...
				<div class="col-md-6 trip-agileitstext welcome-w3lleft"> 
					...
					<div id="owl-demo" class="owl-carousel owl-theme">
						<div class="item agile-item">
							<img src="<%=path %>/images/i1.jpg" class="trip-w3img" alt=""/>  
						</div> 
						<div class="item agile-item">
							<img src="<%=path %>/images/i2.jpg" class="trip-w3img" alt=""/>  
						</div> 
						<div class="item agile-item">
							<img src="<%=path %>/images/i3.jpg" class="trip-w3img" alt=""/>  
						</div>
						<div class="item agile-item">
							<img src="<%=path %>/images/i4.jpg" class="trip-w3img" alt=""/>  
						</div>
						<div class="item agile-item">
							<img src="<%=path %>/images/i1.jpg" class="trip-w3img" alt=""/>  
						</div>
	...
	<div class="news"> 
		<div class="container">
			...
			<link rel="stylesheet" href="<%=path %>/css/jquery.desoslide.css">
			<script src="<%=path %>/js/jquery.desoslide.js"></script> 
			<script>
